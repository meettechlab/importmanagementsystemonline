...
class NonCoalUpdateScreen extends StatefulWidget {
  final QueryDocumentSnapshot<Object?> coalModel;


  const NonCoalUpdateScreen(
      {Key? key, required this.coalModel})
      : super(key: key);

  @override
  _NonCoalUpdateScreenState createState() => _NonCoalUpdateScreenState();
}

class _NonCoalUpdateScreenState extends State<NonCoalUpdateScreen> {
  ...
  void AddData() async {
    if (_formKey.currentState!.validate() && _date != null) {
      final ref = FirebaseFirestore.instance.collection("noncoal").doc(widget.coalModel.get("docID"));
    ...
    coalModel.contact =    widget.coalModel["contact"];
