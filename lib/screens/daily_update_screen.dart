...
class DailyUpdateScreen extends StatefulWidget {
  final QueryDocumentSnapshot<Object?> dailyModel;
  const DailyUpdateScreen({Key? key, required this.dailyModel})
      : super(key: key);
...
class _DailyUpdateScreenState extends State<DailyUpdateScreen> {
  ...
  var transportEditingController;
  var unloadEditingController;
  var depoRentEditingController;
  var koipotEditingController;
  var stoneCraftingEditingController;
  var disselCostEditingController;
  var grissCostEditingController;
  var mobilCostEditingController;
  var extraEditingController;
  ...
  void initState() {
    ...
    unloadEditingController =
        new TextEditingController(text: widget.dailyModel["unload"]);
    depoRentEditingController =
        new TextEditingController(text: widget.dailyModel["depoRent"]);
    koipotEditingController =
        new TextEditingController(text: widget.dailyModel["koipot"]);

    stoneCraftingEditingController =
        new TextEditingController(text: widget.dailyModel["stoneCrafting"]);
    disselCostEditingController =
        new TextEditingController(text: widget.dailyModel["disselCost"]);
    grissCostEditingController =
        new TextEditingController(text: widget.dailyModel["grissCost"]);

    mobilCostEditingController =
        new TextEditingController(text: widget.dailyModel["mobilCost"]);
    extraEditingController =
        new TextEditingController(text: widget.dailyModel["extra"]);
    remarksEditingController =
        new TextEditingController(text: widget.dailyModel["remarks"]);
  }
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [transportField, unloadField],
                    ),
                    SizedBox(
                      height: 20,
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [depoRentField, koipotField],
                    ),
                    SizedBox(
                      height: 20,
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [stoneCraftingField, disselCostField],
                    ),
                    SizedBox(
                      height: 20,
                    ),
  ...
  void AddData()async {
    if (_formKey.currentState!.validate() &&
        _date != null &&
        _chosenCost != null) {
      final ref = FirebaseFirestore.instance.collection("daily").doc(widget.dailyModel.get("docID"));
