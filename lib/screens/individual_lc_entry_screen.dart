...
class IndividualLCEntryScreen extends StatefulWidget {
  ...
  const IndividualLCEntryScreen({Key? key, required this.lcModel})
      : super(key: key);

  @override
  _IndividualLCEntryScreenState createState() =>
      _IndividualLCEntryScreenState();
}

class _IndividualLCEntryScreenState extends State<IndividualLCEntryScreen> {
