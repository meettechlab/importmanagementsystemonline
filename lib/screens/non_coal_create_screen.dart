...
class NonCoalCreateScreen extends StatefulWidget {
  const NonCoalCreateScreen({Key? key}) : super(key: key);

  @override
  _NonCoalCreateScreenState createState() => _NonCoalCreateScreenState();
}
