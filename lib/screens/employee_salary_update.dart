...
class EmployeeSalaryUpdateScreen extends StatefulWidget {
  ...
  const EmployeeSalaryUpdateScreen(
      {Key? key, required this.employeeModel})
      : super(key: key);

  @override
  _EmployeeSalaryUpdateScreenState createState() =>
      _EmployeeSalaryUpdateScreenState();
}

class _EmployeeSalaryUpdateScreenState
    extends State<EmployeeSalaryUpdateScreen> {
  final _formKey = GlobalKey<FormState>();

  var salaryAdvancedEditingController;
  var salaryGivenEditingController;
  ...
  void initState() {
    ...
    salaryGivenEditingController =
        new TextEditingController(text: widget.employeeModel["balance"]);
    remarksEditingController =
        new TextEditingController(text: widget.employeeModel["remarks"]);
  }
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [salaryAdvancedField, salaryGivenField],
                    ),
                    SizedBox(
                      height: 20,
                    ),
  ...
  void AddData() async{
    if (_formKey.currentState!.validate() && _date != null) {
      ...
      employeeModel.docID = widget.employeeModel["docID"];
