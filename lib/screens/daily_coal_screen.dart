...
class DailyCoalScreen extends StatefulWidget {
  const DailyCoalScreen({Key? key}) : super(key: key);

  @override
  _DailyCoalScreenState createState() => _DailyCoalScreenState();
}

class _DailyCoalScreenState extends State<DailyCoalScreen> {
  int _totalCost = 0;
  @override
  void initState() {
    ...
    FirebaseFirestore.instance
      ...
      for (var doc in querySnapshot.docs) {
        if (doc["invoice"].toString().toLowerCase().contains("coal")) {
          setState(() {
          ...
          if (!snapshot.hasData) {
            ...
            return ListView(
              children: [
                ...
                element["invoice"].toString().toLowerCase().contains("coal"))
